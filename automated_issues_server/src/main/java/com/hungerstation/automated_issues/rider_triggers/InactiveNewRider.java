 ...
 */
@Component
public class InactiveNewRider extends Rider implements Executable {
    private Logger logger = LoggerFactory.getLogger(InactiveNewRider.class);
